...
public class Test {
    ...
    public static void sendMsg() throws ClientException {
        String phoneNumber = "13691418387";
        ...
        if(sendSmsResponse.getCode() != null && sendSmsResponse.getCode().equals("OK")) {
            ...
            System.out.print("短信接口返回参数:{'requestId':'"+sendSmsResponse.getRequestId()+"','code':'"+sendSmsResponse.getCode()+"','message':'"+sendSmsResponse.getMessage()+"','bizId':'"+sendSmsResponse.getBizId()+"'}");
        } else {
            System.out.print("短信接口返回参数:{'requestId':'"+sendSmsResponse.getRequestId()+"','code':'"+sendSmsResponse.getCode()+"','message':'"+sendSmsResponse.getMessage()+"','bizId':'"+sendSmsResponse.getBizId()+"'}");
        }
    }
